...
<head>
	...
	<title><?php bloginfo( 'name' ); ?> - <?php echo esc_html( pll__( 'Ametlik veebileht' ) ) ?></title>
			...
			<div class="header__wrapper">
				...
				<nav class="header__menu">
					<ul class="header__menu-list">
						<li>
							<a href="#services" class="header__menu-link"><?php echo esc_html( pll__( 'Teenused' ) ) ?></a>
						</li>
						<li>
							<a href="#portfolio" class="header__menu-link"><?php echo esc_html( pll__( 'Portfoolio' ) ) ?></a>
						</li>
						<li>
							<a href="#faq" class="header__menu-link"><?php echo esc_html( pll__( 'Küsimus-vastus' ) ) ?></a>
						</li>
						<li>
							<a href="#reviews" class="header__menu-link"><?php echo esc_html( pll__( 'Tagasiside' ) ) ?></a>
						</li>
						<li class="menu-list-phone">
							<a href="tel:<?php echo esc_html( pll__( '+37258339290' ) ) ?>" class=""><?php echo esc_html( pll__( '+37258339290' ) ) ?></a>
