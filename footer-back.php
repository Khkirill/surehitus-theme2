				...
				<footer class="footer">
					<div data-speed=".9" class="footer__container container">
							...
							<div class="footer__column">
								...
								<div class="footer__menus">
									<div class="footer__submenu">
										<div class="footer__submenu-title title-3"><?php echo esc_html( pll__( 'Aadress' ) ) ?></div>
						...
						<nav class="footer__navigation">
							<ul class="footer__navigation-list">
								<li>
									<a href="<?= site_url(); ?>" style="display: block; !important"><?php echo esc_html( pll__( 'Tagasi avalehele' ) ) ?></a>
								</li>
								<li>
